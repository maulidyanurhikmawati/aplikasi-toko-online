...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img src="<?php echo base_url('assets/img/slide4.jpg')?>" class="d-block w-100" alt="...">
    </div>
  </div>
    ...
    <?php foreach($barang as $brg) : ?>
        ...
        <div class="card" style="width: 16rem;">
           ...
           <div class="card-body">
            ...
            <small><?php echo $brg->ket ?></small><br>
           <span class="badge badge-danger mb-3">Rp. <?php echo $brg->harga ?></span>
